...
Дан ориентированный граф, заданный в виде ассоциативного массива, где ключ — это вершина, а значение — список вершин, в которые из неё можно перейти:

Схема графа

![Граф](images/graph.webp)
